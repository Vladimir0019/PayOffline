...
Актуальность: 2026-08-03. База описывает поиск GMV-аномалий, пилотный независимый контур
`authzone_tx_share` и patch-версию upstream-запроса `pred_insight.yql`.
